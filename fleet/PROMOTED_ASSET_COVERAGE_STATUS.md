# Promoted Asset Coverage Status

## Purpose
Track which scopes have promoted toolkit or promoted application records above the promotion-package layer.
...
## Best Practices
- update this tracker whenever a scope gains a promoted toolkit or promoted application record
- use it to choose which scopes should gain the next promoted asset type
